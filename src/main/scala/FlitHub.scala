...
class FlitHubNTo1(implicit p: Parameters) extends Module {
...
class FlitSendInterface(implicit p: Parameters) extends Module {
  val io = IO(new Bundle {
...
class FlitHub1ToN(implicit p: Parameters) extends Module {
  val io = IO(new Bundle {
    // Network
...
class FlitRecvInterface(implicit p: Parameters) extends Module {
  val io = IO(new Bundle {
